  ...
  async rewrites() {
    return [
      ...
      // 股票数据
      {
        ...
        destination: 'http://localhost:3002/api/stock/basic/:symbol',
      },
      {
        source: '/api/stock/kline/:symbol',
        destination: 'http://localhost:3002/api/stock/kline/:symbol',
      },
      {
        source: '/api/stock/:symbol',
        destination: 'http://localhost:3002/api/stock/:symbol',
      },
      // 产业链
      {
